              ...
              {inProgressProjects.slice(0, 4).map((project) => {
                ...
                return (
                  <Link
                    ...
                    className={`flex flex-col items-center justify-center gap-2 rounded-2xl bg-[var(--cream)] border-2 ${color.border} p-6 shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all aspect-square`}
                  >
                    ...
                    {project.progress > 0 && (
                      <div className={`w-full ${color.light} rounded-full h-1.5 mt-1`}>
